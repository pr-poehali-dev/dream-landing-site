    ...
    <div className="relative min-h-screen overflow-hidden night-sky font-body text-gold-light">
      ...
      <main className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-20 text-center">
        ...
        >
          ...
          <p>
            ...
            Твои мечты и желания начнут исполняться.
          </p>
        </div>
        ...
        >
          ...
          <p className="mt-2 max-w-md text-center text-[11px] leading-relaxed text-gold-light/40">
            Курс предоставляется в PDF-файле как ваш личный психологический тренажёр. В отличие от видео, текстовый формат работает напрямую с вашим подсознанием: вы не пассивный зритель, а активный участник, который вдумчиво прописывает свои желания, цели и убирает подсознательные страхи.
          </p>
        </div>
      </main>
      ...
      <footer className="relative z-10 pb-8 text-center text-xs text-gold-light/50">
        <div className="mb-3 flex flex-wrap items-center justify-center gap-x-6 gap-y-2">
          <a href="https://cdn.poehali.dev/projects/367338d0-0330-4f92-a349-8653c9326a6f/bucket/1c266fae-958a-4e73-92b6-62f26f545ed1.pdf" target="_blank" rel="noopener noreferrer" className="text-gold-light/70 underline transition-colors hover:text-gold">
